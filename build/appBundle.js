 ...
 * CLI version: 2.8.1
 *
 * Generated: Wed, 12 Oct 2022 13:53:11 GMT
 */

var APP_dev_fxdigital_snake = (function () {
  'use strict';
  ...
  const hexColors = Object.keys(colors).reduce((acc, key) => {
    const currentColor = colors[key].replace("#", "");
    acc[key] = parseInt("0xff".concat(currentColor));
    return acc;
  }, {});
  ...
  const fontStyles = {
    title: {
      fontSize: styles$1.fontSizes.xxxlarge.size,
      fontStyle: "bold",
      lineHeight: styles$1.fontSizes.xxxlarge.height,
      fontFace: "Regular"
    },
    menuItem: {
      fontSize: styles$1.fontSizes.xlarge.size,
      fontStyle: "bold",
      lineHeight: styles$1.fontSizes.xlarge.height,
      fontFace: "Regular"
    }
  };
  ...
  class GameEngine {
    constructor() {
      _defineProperty(this, "updateTimeWindow", 200);

      _defineProperty(this, "timeSinceLastUpdate", 0);
  ...
  class Snake {
    constructor() {
      _defineProperty(this, "color", "olive");
    ...
    update() {
      ...
      this.isDead = this.tail.some((tail, index) => index !== 0 && head.x === tail.x && head.y === tail.y);
      this.isDead = this.isDead || head.x < 0 || head.x > 18 || head.y < 0 || head.y > 10;
    }
  ...
  class Food {
    constructor() {
      _defineProperty(this, "color", "orange");
  ...
  class Game extends lng.Component {
    constructor() {
      ...
      _defineProperty(this, "cellSize", 100);

      _defineProperty(this, "tailItemPadding", 10);

      _defineProperty(this, "itemSize", 80);
    }
    ...
    static _template() {
      return {
        ...
        Score: {
          x: w => w - styles$1.spacing.large,
          y: styles$1.spacing.medium,
          mountX: 1,
          text: { ...fontStyles.title,
            text: "Score: 0",
            textAlign: "right"
          }
        }
    ...
    renderGame() {
      ...
      this.tag("Score").text = "Score: ".concat(score);
    }
  ...
  class Button$2 extends lng.Component {
    static _template() {
      return {
        w: this.styles.w,
        h: this.styles.h,
  ...
  var LngButton = withStyles(Button$2, styles);
  ...
  var Button$1 = withStyles(Button, {
    focused: {
      background: {
  ...
  class Highscore extends lng.Component {
    constructor() {
      super(...arguments);
    ...
    static _template() {
      return {
        ...
        Highscores: {
          ...
          y: 0,
          Title: {
            y: styles$1.spacing.large + styles$1.spacing.medium,
            x: 960,
            mountX: 0.5,
            text: {
              text: "| Highscores |",
          ...
          HighscoreItems: {
            y: styles$1.spacing.large * 3 + styles$1.spacing.medium,
            x: 960,
            mountX: 0.5,
            flex: {
              direction: "column",
        ...
        Buttons: {
          w: 1920,
          h: 540,
          y: 1080 - 540 - styles$1.spacing.medium,
          x: 0,
          flex: {
            direction: "column",
          ...
          GoBackHome: {
            type: Button$1,
            flexItem: {
              marginTop: styles$1.spacing.medium
            },
            title: "Home",
            signals: {
          ...
          ClearHighscores: {
            ...
            signals: {
              buttonPressed: "_clearHighScoreHandler"
            },
    ...
    _renderHighscores() {
      ...
      this.tag("HighscoreItems").children = highscores.map((highscore, index) => {
        return {
          text: {
            text: "".concat(index + 1, ". ").concat(highscore.date, " - ").concat(highscore.score),
            ...fontStyles.menuItem,
  ...
  function setFavicon() {
    try {
      ...
      console.error("I don't really want to deal with this exception, but here it is:", exception);
    }
  }
